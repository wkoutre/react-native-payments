...
export default class PaymentRequest {
  ...
  _getPlatformDetailsIOS(details: PaymentDetailsIOSRaw): PaymentDetailsIOS {
    ...
    return {
      ...
      billingContact: !Boolean(serializedBillingContact) ? null : JSON.parse(serializedBillingContact),
      shippingContact: !Boolean(serializedShippingContact) ? null : JSON.parse(serializedShippingContact),
      paymentToken,
      transactionIdentifier,
      paymentMethod
    };
