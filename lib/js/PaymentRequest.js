...
export default class PaymentRequest {
  ...
  _handleShippingAddressChange(postalAddress: PaymentAddress) {
    ...
    // Eventually calls `PaymentRequestUpdateEvent._handleDetailsUpdate` after a details are returned
  ...
  _getPlatformDetailsIOS(details: PaymentDetailsIOSRaw): PaymentDetailsIOS {
    ...
    return {
      ...
      billingContact: !Boolean(serializedBillingContact)
        ? null
        : serializedBillingContact,
      shippingContact: !Boolean(serializedShippingContact)
        ? null
        : serializedShippingContact,
      paymentToken,
      transactionIdentifier,
      paymentMethod,
    };
